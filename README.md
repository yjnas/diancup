...
1. 点击导航栏的 **SSH终端** 按钮
2. 首次使用需在**系统设置**中配置SSH连接信息
3. 支持多标签页，可同时管理多个会话

### 文件管理

1. 进入**文件管理**页面
2. 浏览文件系统（默认从 `/host` 开始）
3. 支持的操作：
   - 上传/下载文件
   - 新建文件/文件夹
   - 重命名/删除
...
- 🎬 **B站空间**：[昱君NAS](https://space.bilibili.com/668023659)
- 📖 **个人博客**：[wiki.929722.xyz](https://wiki.929722.xyz)
- 💬 **微信号**：dongqc123
- 🛒 **闲鱼店铺**：[昱君NAS小店](https://m.tb.cn/h.7Tfpr15?tk=ambnfAdmiqA)
